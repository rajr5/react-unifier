...
describe("<Button />", () => {
  ...
  test("Custom text color", () => {
    const instance = create(<Button color="white" textColor="blue" text="Hello World" />).root;
    expect(instance.find((element) => element.type === "div").props.className).toContain("blue");
  });
