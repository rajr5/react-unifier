...
test("Touchable handles onTouch callback", () => {
  ...
  const {getByText} = render(<Touchable onTouch={mockOnTouch}>Touchable</Touchable>);
...
test("Touchable handles onMouseEnter callback", () => {
  ...
  const {getByText} = render(<Touchable onMouseEnter={mockOnMouseEnter}>Touchable</Touchable>);
...
test("Touchable handles onMouseLeave callback", () => {
  ...
  const {getByText} = render(<Touchable onMouseLeave={mockOnMouseLeave}>Touchable</Touchable>);
